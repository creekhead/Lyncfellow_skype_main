...
namespace LyncFellow
{
    class iBuddy
    {
        ...
        public bool thisDebug = false;          //debug log true false
        ...
        */
        private void UpdateState()
        {
            ...
            if (thisDebug)
            {
                Trace.WriteLine("UPDATE STATE iBuddy    BYTE STATE: " + state);
            }
            ...
            if (IsAlive)
            {
                ...
                if (result == 0)
                {
                    ...
                    if (thisDebug)
                    {
                        Trace.WriteLine(string.Format("STATE = "+ state + " LyncFellow: WriteFile result=0, GetLastWin32Error()={0}", LastWin32Error));
                    }
